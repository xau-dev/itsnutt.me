...
**ArduPilot** handles the stable flight layer. It deals with the parts that need to be reliable, like stabilization, GPS navigation, failsafes, and return to home.

**ROS 2** handles the experimental autonomy layer, like *vision processing*, *mission logic*, and future higher level decisions.
...
The third challenge is **vision reliability**. Lighting, vibration, camera angle, and motion blur can all affect marker detection. A lot of the work is testing camera placement, reducing vibration, and making the landing logic safer when the marker is lost.
